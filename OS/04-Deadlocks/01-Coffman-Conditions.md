...
| :--- | :--- | :--- | :--- | :--- |
**FCFS** *(First Come First Serve)* | Non-preemptive | Executes processes sequentially in order of arrival. | Simple to implement. 
**Convoy Effect:** Long processes block smaller ones, drastically increasing average WT. |
...
**Priority Scheduling** | Preemptive or Non-preemptive | Executes processes based on assigned priority levels. | Ensures critical tasks run first. | **Starvation:** Low-priority tasks stay blocked.
